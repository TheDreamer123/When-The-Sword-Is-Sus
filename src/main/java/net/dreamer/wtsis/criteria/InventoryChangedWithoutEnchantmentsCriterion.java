...
public class InventoryChangedWithoutEnchantmentsCriterion extends AbstractCriterion<InventoryChangedWithoutEnchantmentsCriterion.Conditions> {
    static final Identifier ID = new Identifier(WhenTheSwordIsSus.MOD_ID,"inventory_changed_without_enchantments");

    public InventoryChangedWithoutEnchantmentsCriterion() {
    }
    ...
    public InventoryChangedWithoutEnchantmentsCriterion.Conditions conditionsFromJson(JsonObject jsonObject,EntityPredicate.Extended extended,AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new InventoryChangedWithoutEnchantmentsCriterion.Conditions(extended, intRange, intRange2, intRange3, itemPredicates);
    }
    ...
    public static class Conditions extends AbstractCriterionConditions {
        ...
        public Conditions(EntityPredicate.Extended player,NumberRange.IntRange occupied,NumberRange.IntRange full,NumberRange.IntRange empty,ItemPredicate[] items) {
            super(InventoryChangedWithoutEnchantmentsCriterion.ID, player);
        ...
        public static InventoryChangedWithoutEnchantmentsCriterion.Conditions items(ItemPredicate... items) {
            return new InventoryChangedWithoutEnchantmentsCriterion.Conditions(EntityPredicate.Extended.EMPTY, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, items);
        }

        public static InventoryChangedWithoutEnchantmentsCriterion.Conditions items(ItemConvertible... items) {
