...
public class InventoryChangedWithEnchantmentsCriterion extends AbstractCriterion<InventoryChangedWithEnchantmentsCriterion.Conditions> {
    static final Identifier ID = new Identifier(WhenTheSwordIsSus.MOD_ID,"inventory_changed_with_enchantments");

    public InventoryChangedWithEnchantmentsCriterion() {
    }
    ...
    public InventoryChangedWithEnchantmentsCriterion.Conditions conditionsFromJson(JsonObject jsonObject,EntityPredicate.Extended extended,AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new InventoryChangedWithEnchantmentsCriterion.Conditions(extended, intRange, intRange2, intRange3, itemPredicates);
    }
    ...
    public static class Conditions extends AbstractCriterionConditions {
        ...
        public Conditions(EntityPredicate.Extended player,NumberRange.IntRange occupied,NumberRange.IntRange full,NumberRange.IntRange empty,ItemPredicate[] items) {
            super(InventoryChangedWithEnchantmentsCriterion.ID, player);
        ...
        public static InventoryChangedWithEnchantmentsCriterion.Conditions items(ItemPredicate... items) {
            return new InventoryChangedWithEnchantmentsCriterion.Conditions(EntityPredicate.Extended.EMPTY, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, items);
        }

        public static InventoryChangedWithEnchantmentsCriterion.Conditions items(ItemConvertible... items) {
