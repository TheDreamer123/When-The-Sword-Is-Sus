...
public class DatDoNotBeHotCriterion extends AbstractCriterion<DatDoNotBeHotCriterion.Conditions> {
    static final Identifier ID = new Identifier(WhenTheSwordIsSus.MOD_ID,"dat_do_not_be_hot");

    public DatDoNotBeHotCriterion() {
    }
    ...
    public DatDoNotBeHotCriterion.Conditions conditionsFromJson(JsonObject jsonObject,EntityPredicate.Extended extended,AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new DatDoNotBeHotCriterion.Conditions(extended, intRange, intRange2, intRange3, itemPredicates);
    }
    ...
    public static class Conditions extends AbstractCriterionConditions {
        ...
        public Conditions(EntityPredicate.Extended player,NumberRange.IntRange occupied,NumberRange.IntRange full,NumberRange.IntRange empty,ItemPredicate[] items) {
            super(DatDoNotBeHotCriterion.ID, player);
        ...
        public static DatDoNotBeHotCriterion.Conditions items(ItemPredicate... items) {
            return new DatDoNotBeHotCriterion.Conditions(EntityPredicate.Extended.EMPTY, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, items);
        }

        public static DatDoNotBeHotCriterion.Conditions items(ItemConvertible... items) {
