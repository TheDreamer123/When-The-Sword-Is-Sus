...
public class DatDoBeHotCriterion extends AbstractCriterion<DatDoBeHotCriterion.Conditions> {
    static final Identifier ID = new Identifier(WhenTheSwordIsSus.MOD_ID,"dat_do_be_hot");

    public DatDoBeHotCriterion() {
    }
    ...
    public DatDoBeHotCriterion.Conditions conditionsFromJson(JsonObject jsonObject,EntityPredicate.Extended extended,AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new DatDoBeHotCriterion.Conditions(extended, intRange, intRange2, intRange3, itemPredicates);
    }
    ...
    public static class Conditions extends AbstractCriterionConditions {
        ...
        public Conditions(EntityPredicate.Extended player,NumberRange.IntRange occupied,NumberRange.IntRange full,NumberRange.IntRange empty,ItemPredicate[] items) {
            super(DatDoBeHotCriterion.ID, player);
        ...
        public static DatDoBeHotCriterion.Conditions items(ItemPredicate... items) {
            return new DatDoBeHotCriterion.Conditions(EntityPredicate.Extended.EMPTY, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, items);
        }

        public static DatDoBeHotCriterion.Conditions items(ItemConvertible... items) {
